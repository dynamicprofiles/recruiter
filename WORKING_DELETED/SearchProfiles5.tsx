                                                    ...
                                                    <div   className="modal fade"  id="staticBackdrop" aria-labelledby="exampleModalLabel"
                                                        ...
                                                        <div className="modal-dialog">
                                                            <div className="modal-content">
                                                                ...
                                                                <Modal open={openEmailModal} onClose={onCloseModal} classNames={{
                                                                    ...
                                                                    <form onSubmit={(e)=> sendEmailMessage(e,profile.PublicProfileRandomNumber)} >
                                                                        <div className="mb-3">
                                                                        ...
                                                                        <div className="modal-footer d-block">
                                                                            <button type="submit" value={"submit"} className="btn btn-warning float-end">Send Mail</button>
                                                                        </div>
                                                                    </form>
                                                                </Modal>
                                                            </div>
