...
function SearchProfiles5(props:any) {
    ...
    return (
        <div>
            ...
            <div className="container-fluid">
                <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapseSearch"
                    ...
                    <div className="col-12 col-sm-3 col-xl-2 px-sm-2 px-0 bg-dark d-flex sticky-top">
                        <div
                            ...
                            <ul className="nav nav-pills flex-sm-column flex-row flex-nowrap flex-shrink-1 flex-sm-grow-0 flex-grow-1 mb-sm-auto mb-0 justify-content-center align-items-center align-items-sm-start"
                                ...
                                <li>
                                    <a href="#navbarCollapseSearch" data-bs-toggle="collapse" className="nav-link px-sm-0 px-2">
...
export default SearchProfiles5;